...
// Source: first20hours/google-10000-english, google-10000-english-usa-no-swears.txt.
// The source is ordered by frequency from Google's Trillion Word Corpus derivative; this list filters
// to lowercase alphabetic 5-letter entries and takes the first 1000 without re-sorting.
export const COMMON_5_WORDS = [
...
export const common5CharConfig: SessionConfig = {
  condition_id: 'five_char_common_words_n1000',
  alphabet: [...COMMON_5_WORDS],
