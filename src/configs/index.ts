...
import { ergonomicNonword3CharConfig } from './ergonomicNonword3Char';
...
import { ergonomicNonword5CharConfig } from './ergonomicNonword5Char';
...
export const conditionOptions: ConditionOption[] = [
  ...
  { label: '3-char ergonomic non-words (N=1000)', config: ergonomicNonword3CharConfig },
